...
int main() {
    ...
    const int bok_mapy = 300;

    // Liczba osobników zarażonych na początku epidemii.
    const long chorzy_dnia_zero = 70;
    ...
    for (int eksp_nr = 0; eksp_nr < ile_eksperymentow; ++eksp_nr) {
        ...
        miasto.zapisz_do_pliku("mapa1.txt");
        }
        ...
        for (int dzien = 0; dzien < ile_dni; ++dzien) {
            ...
            if(miasto.ilu_chorych() > 10000 && was_high == false)
            {
                was_high = true;
            }
            if(miasto.ilu_chorych() < 10000 && was_high == true)
            {
                miasto.wirus.beta = 0.9;
            }
            if (eksp_nr == ile_eksperymentow-1){
            if(dzien == 20){
                miasto.zapisz_do_pliku("mapa2.txt");
            }
            if(dzien == 40){
                miasto.zapisz_do_pliku("mapa3.txt");
            }
            if(dzien == 65){
                miasto.zapisz_do_pliku("mapa4.txt");
            }
            if(dzien == 100){
                miasto.zapisz_do_pliku("mapa5.txt");
            }}
        ...
        if (eksp_nr == ile_eksperymentow-1) {            
            ...
            miasto.zapisz_do_pliku("mapa6.txt");
